...
namespace Depot.SourceGenerator
{
    public static partial class Utils
    {
        ...
        {
            var sheetguid = d.JObject["sheet"].Value<string>(); //this is the configured column data field that points to the sheet the line refs come from. every lineref has it
